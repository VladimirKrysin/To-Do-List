...
const user = <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className='wrapper'>
            <div className="container" >
                <Flex className="content-container" direction="column" gap={'2rem'}>
                    <Flex direction="column" gap={'0.75rem'}>
                        <h1 className='title'>Sign In</h1>
                        <TextInputBase value={userName} placeholder="Enter Username" leftSection={user} />
                        <TextInputBase placeholder="Enter Password" leftSection={password} />
                        <Button onClick={onLoginClick} size="sm" classNames={{ root: 'button-login' }} variant="filled" color="rgba(255, 144, 144, 1)" radius="0.3rem">
                            <span className="button-login-text">Login</span>
                        </Button>
                        <span className="register-account">Don't have an account? <Link to={'/register'} style={{ textDecoration: 'none' }}>Create one</Link></span>
                    </Flex>
                    {/* <Flex className="socials" direction="column" gap={'1rem'} >
                        <Flex gap={'1.25rem'}>
